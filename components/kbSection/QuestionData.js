...
const questionsData = {
  "QLED MINI": [
    {
      ...
      des: [
        {
          description: "Skyworth QLED Mini is an advanced version of QLED technology that concentrate on improving contrast and black levels by harnessing precise backlighting control.",
        }]
    },
    {
      ...
      des: [
        ...
        },
        {
          ...
          description: "Synchronizes the TV's refresh rate with the frame rate of the content, reducing screen tearing for smoother gameplay. "
        },
        {
          title: "Auto Low Latency Mode (ALLM):",
          description: "Automatically switches to a low-latency setting for gaming consoles, reducing input lag and enhancing responsiveness."
        }
      ]
    },
    {
      ...
      des: [
        {
          description: "Yes, Mini QLED TVs are excellent for gaming due to their low input lag, support for features like ALLM and VRR, and enhanced visual quality, making them ideal for both casual and competitive gamers.",
        }]
    },
    {
      ...
      des: [
        {
          title: "Dolby Audio ",
          description: "is a technology that enhances sound quality for a more immersive audio experience, optimizing audio for clarity and impact."
        },
        {
          title: "Dolby Vision Atmos ",
          description: "combines advanced HDR imaging with immersive audio, allowing sound to move freely around you in a three-dimensional space. This technology creates a more realistic sound environment, complementing the stunning visuals provided by compatible content"
        },]
    },
    {
    ...
    //next
    {
      ...
      des: [
        {
          description: "Yes, all our TVs are wall-mount compatible. Be sure to check the specifications for recommended mount types and sizes.",
        }]
    },
    {
    ...
    },
    {
      ...
      des: [
        {
          description: "For any support inquiries, please contact our customer service team for assistance. To call dial 042 111 635 635 and for toll free dial 0800 111 635 or email at CS@skyworthpakistan.com."
        }]
    },
    {
      ...
      des: [
        ...
        {
          title: "Game Mode:",
          description: "Optimized for gaming, reducing input lag and ensuring smooth gameplay."
        },
        {
          title: "Far Field Voice Control:",
          description: "Use voice commands from across the room to control your TV and connected devices."
        },
        {
          title: "Filmmaker Mode:",
          description: "Enjoy movies as the creators intended, with optimized settings for a true cinematic experience."
        }
      ]
    },
    {
    ...
    {
      text: "What is benefits of 144hz?",
      popularity: 4,
      views: 140,
      des: [
        {
          description: "SKYWORTH 144Hz Naïve Panel is to providing the ability to Play Games and Streaming content to enjoy the fluidity and precision of every frame."
        }]
    },
    {
      ...
      des: [
        {
          description: "SKYWORTH QLED-Mini TV has the high speed HDMI2.1 and AMD FreeSYNC which ensure to meet the TOP-Tier Game Tech."
        }]
    },
    {
    ...
    },
    {
      ...
      des: [
        {
          description: "HDR10+ (HDR 10 plus) is a high dynamic range (HDR) video technology that adds dynamic metadata to HDR10 source files. The dynamic metadata are used to adjust and optimize each frame of the HDR video to the consumer display's capabilities in a way based on the content creator's intentions."
        },
        {
          description: "HDR10+ can be used to more accurately adjust brightness levels up to the full range of PQ (Perceptual Quantizer) code values (10,000 nits maximum brightness) on a scene-by-scene or frame-by-frame basis."
        }]
    },
    {
  ...
  QLED: [
    ...
    },
    {
      ...
      des: [
        {
          description: "QLED TVs generally have a long lifespan as compared to other options available. They are more resistant to burn-in compared to other LED TVs. However the lifespan also depends on its usage, settings and the environment (commercial or domestic)."
        }]
    },
    {
      text: "What is the difference between Dolby Audio and Dolby Vision Atmos?",
    ...
    },
    {
      ...
      des: [
        {
          description: "Yes, all our smart TVs come with built-in Wi-Fi capabilities, allowing you to connect to your home network for streaming and online features."
        }]
    },
    {
      text: "How do I set up my new TV?",
  ...
  UHD: [
    {
      ...
      des: [
        {
          description: "UHD refers to a resolution of 3840 x 2160 pixels, which allows for sharper, more detailed images, especially on larger screens."
        }]
    },
    {
    ...
    },
    {
      ...
      des: [
        {
          description: "UHD provides more detail and clarity, particularly on larger screens, making images appear more lifelike. The higher pixel density also enhances the viewing experience for HDR content with better color and contrast."
        }]
    },
    {
